...
sealed interface ShowAction {
     ...
     * manual/interactive counterpart at the series level the way Movie/Episode have, since Sonarr's
     * release picker is per-episode, not per-series.
     */
    ...
    /**
     * Toggles a "download this season once it's available" request for a missing-season placeholder
     * card - queues it if not already queued, cancels it otherwise.
     */
