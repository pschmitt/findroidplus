package dev.pschmitt.jellyfin.presentation.setup.addserver
...
import dev.pschmitt.jellyfin.setup.presentation.addserver.AddServerState
import dev.pschmitt.jellyfin.setup.presentation.addserver.AddServerViewModel
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                leadingIcon = {
                    Icon(
                        painter =
                            painterResource(id = dev.pschmitt.jellyfin.core.R.drawable.ic_server),
