package dev.pschmitt.jellyfin.presentation.setup.welcome
...
private fun WelcomeScreenLayout(onAction: (WelcomeAction) -> Unit) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text(
                text = stringResource(dev.pschmitt.jellyfin.setup.R.string.welcome),
                style = MaterialTheme.typography.displayMedium,
            )
            Spacer(modifier = Modifier.height(MaterialTheme.spacings.default))
            Text(
                text = stringResource(dev.pschmitt.jellyfin.setup.R.string.welcome_text),
