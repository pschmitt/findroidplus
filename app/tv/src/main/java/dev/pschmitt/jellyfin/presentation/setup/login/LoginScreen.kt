package dev.pschmitt.jellyfin.presentation.setup.login
...
import dev.pschmitt.jellyfin.setup.presentation.login.LoginState
import dev.pschmitt.jellyfin.setup.presentation.login.LoginViewModel
...
private fun LoginScreenLayout(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = dev.pschmitt.jellyfin.setup.R.string.login),
            ...
            Text(
                text =
                    stringResource(
                        dev.pschmitt.jellyfin.setup.R.string.server_subtitle,
                        state.serverName ?: "",
                    ),
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(
                        text =
                            stringResource(
                                id = dev.pschmitt.jellyfin.setup.R.string.edit_text_username_hint
                            )
                    )
                },
                singleLine = true,
            ...
            OutlinedTextField(
                ...
                label = {
                    Text(
                        text =
                            stringResource(
                                id = dev.pschmitt.jellyfin.setup.R.string.edit_text_password_hint
                            )
                    )
                },
                singleLine = true,
                ...
                Button(
                    ...
                    Box(modifier = Modifier.fillMaxWidth()) {
                        ...
                        Text(
                            text =
                                stringResource(
                                    id = dev.pschmitt.jellyfin.setup.R.string.login_btn_login
                                ),
            ...
            AnimatedVisibility(state.quickConnectEnabled) {
                Column {
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(dev.pschmitt.jellyfin.setup.R.string.or),
                                ...
                                Text(
                                    text =
                                        if (state.quickConnectCode != null) {
                                            ...
                                            stringResource(
                                                dev.pschmitt.jellyfin.setup.R.string
