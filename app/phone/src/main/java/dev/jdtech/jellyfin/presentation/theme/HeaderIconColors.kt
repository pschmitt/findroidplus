 ...
 * scheme, whose tonal primary/secondary/tertiary are close cousins of the same seed hue and read
 * as near-identical at a glance, which defeats the point of a per-screen color.
 */
