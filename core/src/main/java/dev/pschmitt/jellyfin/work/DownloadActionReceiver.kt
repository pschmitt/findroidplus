...
class DownloadActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_CANCEL = "dev.pschmitt.jellyfin.action.CANCEL_DOWNLOAD"
        const val ACTION_PAUSE = "dev.pschmitt.jellyfin.action.PAUSE_DOWNLOAD"
        const val ACTION_PAUSE_ALL = "dev.pschmitt.jellyfin.action.PAUSE_ALL_DOWNLOADS"
