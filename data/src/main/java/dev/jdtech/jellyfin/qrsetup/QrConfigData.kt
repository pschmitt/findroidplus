 ...
 * [dev.jdtech.jellyfin.backup.BackupEnvelope] reused wholesale: that type's
 * [dev.jdtech.jellyfin.backup.BackupEnvelope.preferences] is a dump of *every* `SharedPreferences`
