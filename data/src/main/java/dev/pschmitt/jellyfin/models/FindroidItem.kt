 ...
 * storage volume it lived on got reformatted or unmounted. [FindroidSource.size] is a live
 ...
 * episodes), so there's no equivalent on the base [FindroidItem] - only episodes carry
 * [FindroidEpisode.lastPlayedDate]. Drives both the worker's own deletion pass and the "marked for
