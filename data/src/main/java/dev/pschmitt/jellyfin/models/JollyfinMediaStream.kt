...
data class JollyfinMediaStream(
    val title: String,
...
fun MediaStream.toJollyfinMediaStream(jellyfinRepository: JellyfinRepository): JollyfinMediaStream {
    return JollyfinMediaStream(
        title = title.orEmpty(),
...
fun JollyfinMediaStreamDto.toJollyfinMediaStream(): JollyfinMediaStream {
    return JollyfinMediaStream(
        title = title,
        displayTitle = displayTitle,
        language = language,
